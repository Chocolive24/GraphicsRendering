...
void GameFrame()
{
    Graphics::DrawRect(Vector2F(Input::mousePos.x - 100, Input::mousePos.y- 50),    200.f, 100.f, Color::yellow);
    ...
    if (Timer::totalTime <= 2.0)
    {
        ...
        Graphics::DrawCircle(Vector2F(sapp_width() / 2.f, sapp_height() / 2.f), 50.f, 50, Color::red);
